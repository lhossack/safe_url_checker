...
class DatabaseABC(metaclass=abc.ABCMeta):
    ...
    def check_url_has_malware(self, host_and_query) -> bool:
        ...
        :param str host_and_query: Host and query in format: 
        {hostname_and_port}/{original_path_and_query_string} 
        That is, they don't contain the protocol (e.g. "https://" is trimmed), 
        but may include ports: 
        e.g. https://www.google.com/search/path?query=1&here=2 
        should be passed in as www.google.com:443/search/path?query=1&here=2
